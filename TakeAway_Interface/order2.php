    ...
    <div class="container">
		...
		<div class="container">
			...
			<table>
				<tr>
					<td>
					  <label>
						<input type="radio" name="survey" data-price="42" id="d1" value="Orange Juice">
					  </label>
					</td>
					<td>
					...
					<td>
					  <label>
						<input type="radio" name="survey" data-price="42" id="d2" value="Apple Juice">
					  </label>
					</td>
					<td>
				...
				<tr>
					<td>
					  <label>
						<input type="radio" name="survey" data_price="39" id="d3" value="Perrier">
					  </label>
					</td>
					<td>
					...
					<td>
					  <label>
						<input type="radio" name="survey" data_price="66" id="d4" value="Vitel">
					  </label>
					</td>
					<td>
				...
				<tr>
					<td>
					  <label>
						<input type="radio" name="survey" data_price="42" id="d5" value="Grapefruit Juice">
					  </label>
					</td>
					<td>
					...
					<td>
					  <label>
						<input type="radio" name="survey" data-price="42" id="d6" value="Pineapple Juice">
					  </label>
					</td>
					<td>
				...
				<tr>
					<td>
					  <label>
						<input type="radio" name="survey" data-price="66" id="d7" value="Eau De Perrier">
					  </label>
					</td>
					<td>
					...
					<td>
					  <label>
						<input type="radio" name="survey" data-price=="0" id="none" value="" checked="checked">
					  </label>
					</td>
					<td>
						&nbsp &nbsp None
			...
			<table width="100%">
				<tr> 
					...
					<td><a onclick="SubMitFood()"><img onclick="SubMitFood()" src="./img/orderpay.png" alt="" style="text-align:right" width="150px"></a></td>
				</tr> 
			</table>
				<table width="100%">
		...
		<script>
			...
			function SubMitFood() {
				...
				//alert(order_String)
				document.getElementById("form").innerHTML += "<input type='text' id='counter' name='counter' value='" + i + "'>"
